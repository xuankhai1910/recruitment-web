...
const sectionH3 =
  "mb-4 font-display text-[22px] font-bold tracking-tight text-ink";
const bulletLi =
      ...
      <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-10 px-7 py-14 lg:grid-cols-[1fr_360px]">
        ...
        <aside className="flex flex-col gap-5">
          <div className={asideCard}>
            ...
            <Link
              to={`/companies/${co._id}`}
              className={ui.btnOutline + " w-full"}
            >
              ...
              <div className="mt-4 flex flex-col gap-2 border-t border-line-soft pt-3">
                {company?.email && (
                  <a
                    ...
                    className="flex items-center gap-2 text-[13px] text-slate-600 hover:text-ink"
                  >
