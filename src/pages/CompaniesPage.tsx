  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center gap-3 rounded-xl border border-dashed border-border/60 bg-card py-20">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {companies.map((c) => (
            <Link key={c._id} to={`/companies/${c._id}`}>
              <Card className="group h-full cursor-pointer border border-border/60 transition-all duration-200 hover:border-primary/30 hover:bg-accent/30">
                <CardContent className="flex flex-col items-center p-6 text-center">
                  {c.logo ? (
                    ...
                    <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-xl bg-secondary">
