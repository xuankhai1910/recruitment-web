			...
			<div className="mx-auto grid max-w-[1280px] grid-cols-2 gap-12 px-7 pb-8 pt-14 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
				<div className="col-span-2 flex flex-col gap-4 md:col-span-1">
					...
					<p className="max-w-xs text-sm leading-relaxed text-white/65">
						Nền tảng tuyển dụng dành cho ứng viên Việt Nam. Tìm công việc phù hợp
						với hệ thống gợi ý AI và hồ sơ kỹ năng cá nhân.
					</p>
				</div>
				<FooterCol
					title="Ứng viên"
				...
				<FooterCol
					...
					links={[
						...
						{ to: "/jobs", label: "Điều khoản" },
						{ to: "/jobs", label: "Bảo mật" },
					]}
				/>
			</div>
