...
import { Banknote, Briefcase, Building2, CalendarX2, Clock, MapPin } from "lucide-react";
...
export function RecommendedJobCard({ item }: RecommendedJobCardProps) {
	...
	return (
		<div className="group relative flex h-full flex-col rounded-xl border border-slate-200 bg-white p-4 transition-all duration-200 hover:border-blue-300 hover:shadow-md">
				...
				<div className="mt-2 grid grid-cols-2 gap-x-3 gap-y-2 text-xs text-slate-400">
					...
					<span className="col-span-2 inline-flex min-w-0 items-center gap-1">
						...
						<span className="font-medium text-rose-500">
							Hết hạn {format(new Date(job.endDate), "dd/MM/yyyy")}
						</span>
					</span>
				</div>
