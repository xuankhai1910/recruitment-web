      ...
      <div className="flex flex-wrap items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            <Badge
              variant="outline"
              className="shrink-0 border-teal-200 bg-teal-50 font-normal text-teal-700"
            >
    ...
    <div className="rounded-xl border border-teal-200 bg-teal-50 p-4">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <Badge
          ...
          className={
            isAi
              ? "border-teal-200 bg-white font-normal text-teal-700"
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <InfoRow icon={Target} label="Kinh nghiệm & Trình độ">
      ...
      <Separator className="my-3 bg-teal-200/60" />
          ...
          <div className="flex flex-wrap gap-1.5">
            {extractedData.skills.map((s) => (
              <Badge
                key={s}
                variant="outline"
                className="border-teal-200 bg-white font-normal text-teal-700"
              >
                {s}
              </Badge>
            ))}
